...
if ($7mmLink -notmatch $VideoId) {
    $7mmLink = (((((($GoogleSearch.Links.href -match '7mmtv.tv/../uncensored_content')) -replace '7mmtv.tv/..', '7mmtv.tv/en') -replace '\/url\?q=', '') -split "&amp;")[0])
    Write-Host $7mmLink
...
$Tags = $7mmScrape.Links | Where-Object { $_.outerHTML -match '_category\/' }